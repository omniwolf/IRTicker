...
namespace IRTicker {
    public class DCE {
        ...
        public Dictionary<string, int> currencyFiatDivision = new Dictionary<string, int>();  // a place to store each currency and it's minimum fiat division (eg IR bitcoin is 0.01 - you can be accurate to 1c when placing an order)
