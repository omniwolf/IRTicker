...
namespace IRTicker {
    public class PrivateIR {
        ...
        public DateTime? earliestClosedOrderRequired = null;  // optimise closed orders by only pulling what's required.  If null we just pull a static 10 to cover the closed orders UI
